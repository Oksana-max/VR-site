      ...
      function e(t, i) {
        ...
        if (
          ...
          (this.onMouseEnter = function () {
            s.isMouseEntering || (_(s.el, s.classNames.mouseEntered), s.showScrollbar("x"), s.showScrollbar("y"), (s.isMouseEntering = !0)),
              s.onMouseEntered();
          }),
          ...
          (this.drag = function (t) {
            ...
            if (s.draggedAxis && s.contentWrapperEl) {
              var v = s.axis[s.draggedAxis].track,
                ...
                b =
                  null !== (o = null === (l = s.contentWrapperEl) || void 0 === l ? void 0 : l[s.axis[s.draggedAxis].scrollSizeAttr]) && void 0 !== o
                    ? o
                    : 0,
                g = parseInt(
                ...
                y =
                  ((x =
                    "x" === s.draggedAxis && s.isRtl
                      ? (null !== (d = null === (u = v.rect) || void 0 === u ? void 0 : u[s.axis[s.draggedAxis].sizeAttr]) && void 0 !== d ? d : 0) -
                        m.size -
                        x
                      : x) /
                    (f - m.size)) *
              ...
              "x" === s.draggedAxis &&
                s.isRtl &&
                (y = (null === (p = e.getRtlHelpers()) || void 0 === p ? void 0 : p.isScrollingToNegative) ? -y : y),
      ...
      return (
        (e.getRtlHelpers = function () {
          ...
          return (
            ...
            (e.rtlHelpers = { isScrollOriginAtZero: r.left !== l.left, isScrollingToNegative: l.left !== o.left }),
            e.rtlHelpers
          );
        }),
        ...
        (e.prototype.initDOM = function () {
          ...
          (this.wrapperEl = this.el.querySelector(P(this.classNames.wrapper))),
            ...
            (this.axis.x.scrollbar.el =
              (null === (e = this.axis.x.track.el) || void 0 === e ? void 0 : e.querySelector(P(this.classNames.scrollbar))) || null),
            (this.axis.y.scrollbar.el =
              (null === (t = this.axis.y.track.el) || void 0 === t ? void 0 : t.querySelector(P(this.classNames.scrollbar))) || null),
        ...
        (e.prototype.onTrackClick = function (e, t) {
          ...
          if (this.options.clickOnTrack && n.scrollbar.el && this.contentWrapperEl) {
            ...
            var c =
                null !== (s = null === (i = this.axis[t].scrollbar.rect) || void 0 === i ? void 0 : i[this.axis[t].offsetAttr]) && void 0 !== s
                  ? s
                  : 0,
              h = parseInt(
                null !== (l = null === (r = this.elStyles) || void 0 === r ? void 0 : r[this.axis[t].sizeAttr]) && void 0 !== l ? l : "0px",
                10,
              ),
